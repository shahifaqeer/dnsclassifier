...
#######################################################################
# dns_classify.py: parses dns responses and matches input IP address
# with application
# CS8001 project Fall 2013
# Sarthak Grover
#######################################################################
...
This component builds on DNSSpy. It spies on DNS replies, stores the
results, and raises events when things are looked up or when its stored
...
def launch (no_flow = False):
  core.registerNew(DNSClassify, not no_flow)
